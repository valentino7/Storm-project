...
public class Costant {
    ...
    public static final int NUM_GLOBAL_15M_BOLT = 1;
    public static final int NUM_GLOBAL_1H_BOLT = 1;
    public static final int NUM_GLOBAL_24H_BOLT = 1;
    ...
    public static final int NUM_INTERMEDIATERANK15M = 3;
    public static final int NUM_INTERMEDIATERANK1H = 3;
    public static final int NUM_INTERMEDIATERANK24H = 3;
